...
MANE_TRANSCRIPTS_FILE = os.path.join(
    BOOSTDM_DATASETS, "saturation", "cds-5spli.regions.gz"
)
...
}  # TODO: is "intron_variant" necessary?
...
COLUMNS_OUTPUT = (
    ["gene", "ENSEMBL_TRANSCRIPT", "ENSEMBL_GENE", "chr", "pos", "alt", "aachange"]
    + COLUMNS_TRAINING
